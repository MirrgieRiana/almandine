...
public class CardEntityWireRedstone extends CardEntityWire<EntityWireRedstone>
{
	...
	@Override
	public Optional<EntityWireRedstone> create(Connection begin, Connection end)
	{
		return isDuplicated(begin, end) ? Optional.empty() : Optional.of(new EntityWireRedstone(begin, end));
	}

	@Override
	public View<EntityWireRedstone> getView()
	{
		return new ViewEntityWireRedstone();
	}
